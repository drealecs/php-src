...
0004 JMPZ T2 0010
0005 INIT_FCALL_BY_NAME 2 string("plusn")
0006 SEND_VAR_EX CV0($x) 1
0007 SEND_VAR_EX CV1($n) 2
0008 T2 = DO_FCALL_BY_NAME
0009 RETURN T2
0010 INIT_FCALL_BY_NAME 2 string("plusn")
0011 SEND_VAR_EX CV0($x) 1
0012 SEND_VAR_EX CV1($n) 2
0013 T2 = FUNC_GET_ARGS int(1)
0014 SEND_UNPACK T2
0015 CHECK_UNDEF_ARGS
0016 T2 = DO_FCALL_BY_NAME
0017 RETURN T2
array(10) {
  [0]=>
  int(3)
