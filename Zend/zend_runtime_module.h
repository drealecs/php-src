...
ZEND_API void zend_runtime_module_remove_visible_class(zend_runtime_module *module, zend_string *key, zend_class_entry *ce);
...
ZEND_API void zend_runtime_context_remove_visible_function(zend_runtime_context *context, zend_string *key, zend_function *function);
...
ZEND_API void zend_runtime_context_remove_visible_internal_function(zend_string *key, zend_function *function);
...
ZEND_API void zend_runtime_context_remove_visible_internal_constant(zend_string *key, zend_constant *constant);
